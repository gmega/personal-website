...
Note that so far we have not said anything about which part of the Merkle DAG gets published in the provider record. This is because that is a decision of the peer. By default, for instance, Kubo (the IPFS Go Client) [will index **every single CID in the DAG**](https://github.com/ipfs/kubo/blob/master/docs/config.md#reproviderstrategy) into the DHT.
