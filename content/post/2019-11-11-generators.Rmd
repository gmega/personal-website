...
knitr::include_graphics('/img/posts/2019-11-11-generators/generator.png', error = FALSE)
```
...
knitr::include_graphics('/img/posts/2019-11-11-generators/continuation.png', error = FALSE)
```
